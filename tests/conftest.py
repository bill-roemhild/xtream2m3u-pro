...
def app_factory(tmp_path, monkeypatch):
    def _create(**env_overrides):
        ...
        paths = {
            ...
            "service_catalog_cache": data_dir / "service_catalog_cache.json",
            "service_epg_cache": data_dir / "service_epg_cache.json",
        ...
        env = {
            ...
            "SERVICE_CATALOG_CACHE_PATH": str(paths["service_catalog_cache"]),
            "SERVICE_EPG_CACHE_PATH": str(paths["service_epg_cache"]),
        ...
        return {
            ...
            "paths": {
                ...
                "SERVICE_CATALOG_CACHE_PATH": Path(env["SERVICE_CATALOG_CACHE_PATH"]),
                "SERVICE_EPG_CACHE_PATH": Path(env["SERVICE_EPG_CACHE_PATH"]),
